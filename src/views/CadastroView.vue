...
<template>
    <section v-if="currentStep === 1" class="flex flex-col justify-center items-center text-center mt-10 mb-5">
        ...
        <div class="flex justify-center items-center gap-12">
            <div class="w-full max-w-md">
                <ul class="text-left w-full">
                    ...
                    <li class="mt-2">
                        ...
                        <div class="relative w-full">
                            <input :type="showPassword ? 'text' : 'password'" name="senha"
                    ...
                    <li class="mt-2 w-full">
                        ...
                        <div class="flex items-center border border-gray-400 rounded w-full mb-10">
                            <input :type="showConfirmPassword ? 'text' : 'password'" id="confirmesenha"
                                placeholder="Confirme sua senha"
                                class="flex-1 py-3 pl-2 pr-3 placeholder-gray-500 outline-none rounded bg-transparent" />
                            <span @click="toggleConfirmPassword" class="cursor-pointer text-gray-600 text-xl px-3">
                ...
                <button @click="nextStep"
                    ...
                    Continuar <span class="mdi mdi-arrow-right"></span></button>
                <div class="text-left mt-2">
                    <p>Já faz parte de um setor? <a href="#" class="text-[#2D88D4]">Clique aqui</a></p>
                    <p><a href="LoginView.vue" class="text-[#2D88D4] underline cursor: pointer">Já possuo uma conta.</a>
                    </p>
                </div>
            </div>
        </div>
        <img src="/public/mobile-login.png" alt="mobile" class="w-100 ml-auto -mt-50 mr-40">
        <button @click="goHome"
    ...
    <section v-if="currentStep === 2" class="flex flex-col justify-center items-center text-center mt-10">
        <img src="/public/LogoIFC.png" alt="logo" class="w-40rem h-20rem mb-4">
        ...
        <div>
            ...
            <button @click="prevStep"
                ...
                <span class="mdi mdi-arrow-left"></span> Voltar</button>
        </div>
    </section>

    <section v-if="currentStep === 3" class="flex flex-col justify-center items-center text-center mt-20">
            ...
            <div class="w-full max-w-md">
                <ul class="text-left w-full">
                    ...
                    <li class="mt-3">
                        ...
                        <input type="number" class="border border-gray-400 rounded py-3 pr-3 pl-2 w-full no-spinner">
                    </li>
                    <li class="mt-3 mb-5 w-full">
                        ...
                        <select name="curso" id="curso"
                            ...
                            <option value="1" class="text-gray-500 cursor-pointer">Informática para Internet</option>
        ...
        <ul class="flex justify-between w-full px-8">
            <li class="flex flex-col items-center relative">
                <span :class="[
                    ...
                    currentStep > 1 ? 'mdi mdi-circle text-[#386641]'
                        : currentStep === 1 ? 'mdi mdi-record-circle text-[#386641]'
                            : 'mdi mdi-record-circle text-[#C0C0C0]'
                ]">
                </span>
                <p class="text-[#386641] text-center" :class="currentStep >= 1 ? 'text-[#386641]' : 'text-[#736C6C]'">
                    Informações Iniciais</p>
                <p class="text-center text-[#C0C0C0]">Email e senha</p>
            </li>
            <li class="flex flex-col items-center relative">
                <span :class="[
                    'text-3xl w-9 h-9 text-center rounded-full bg-gray-100',
                    currentStep > 2 ? 'mdi mdi-circle text-[#386641]'
                        : currentStep === 2 ? 'mdi mdi-record-circle text-[#386641]'
                            : 'mdi mdi-record-circle text-[#C0C0C0]'
                ]">
                </span>

                <p class="text-[#736C6C] text-center" :class="currentStep >= 2 ? 'text-[#386641]' : 'text-[#736C6C]'">
                    Confirme sua Identidade</p>
                <p class="text-[#C0C0C0] text-center">Verificação</p>
            </li>
            <li class="flex flex-col items-center relative">
                <span :class="[
                    'text-3xl w-9 h-9 text-center rounded-full bg-gray-100',
                    currentStep === 3 ? 'mdi mdi-record-circle text-[#386641]'
                        : 'mdi mdi-record-circle text-[#C0C0C0]'
                ]">
                </span>
                <p class="text-[#736C6C] text-center" :class="currentStep === 3 ? 'text-[#386641]' : 'text-[#736C6C]'">
                    Detalhes Finais</p>
